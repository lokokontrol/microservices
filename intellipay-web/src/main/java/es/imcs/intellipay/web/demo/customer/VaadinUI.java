...
public class VaadinUI extends UI {
	...
	//Cuando seleccionas uno de la lista para Editarlo
	...
	//Cuando clickeas a New customer para q salga la ventanita editCustomer
	// Instantiate and edit new Customer the new button is clicked
	addNewBtn.addClickListener(e -> editor.editCustomer(new Customer(null, "", "")));

	
	// Cuando creas uno nuevo o borras, para que refresque la lista.
